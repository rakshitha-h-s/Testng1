    ...
    public void selectDateAndMonth(String date1)
    {
    	...
    	for (int rowNum = 2; rowNum <= 7; rowNum++) {
    	    for (int colNum = 1; colNum <= totalWeekDays; colNum++) {
    	        ...
    	        dayValue = element.getText();
    	        if (dayValue.trim().isEmpty() && rowNum != 2 && colNum != 1) {
    	        	System.out.println("dayValue is null: " + dayValue);
    	            throw new NoSuchElementException("enter proper date");
    	        }
